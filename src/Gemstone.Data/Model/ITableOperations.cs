...
namespace Gemstone.Data.Model
{
    ...
    public interface ITableOperations
    {
        ...
        /// is generated by <see cref="GetSearchRestriction(IRecordFilter)"/> using <paramref name="IRecordFilter"/>.
        /// </para>
        /// </remarks>
        ...
        /// </summary>
        /// <param name="restriction">Record restrictions to apply, if any.</param>
        /// <returns>
        /// Record count for the specified <paramref name="restriction"/> - or - total record count
        /// for the modeled table if no <see cref="RecordRestriction"/> is provided</c>.
        /// </returns>
        /// <remarks>
        /// If any of the <paramref name="restriction"/> parameters reference a table field that is modeled with
        /// either an <see cref="EncryptDataAttribute"/> or <see cref="FieldDataTypeAttribute"/>, then the function
        ...
        /// <returns>
        /// <see cref="RecordRestriction"/> based on fields marked with <see cref="SearchableAttribute"/>, Property Names and specified <paramref name="recordFilters"/>.
        /// </returns>
        /// <remarks>
        ...
        /// specified value in the <see cref="IRecordFilter"/> as encryption is handled locally. However, the <see cref="SearchRecords"/> function
        /// can be used to find data in encrypted fields that are marked for search with other limits.
        /// </remarks>
        RecordRestriction[]? GetSearchRestrictions(params IRecordFilter?[]? recordFilters);
